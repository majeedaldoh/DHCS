...
export default function data() {
  const Author = ({ image, name, email }) => (
    <MDBox display="flex" alignItems="center" lineHeight={1}>
      <MDAvatar src={image} nameCOVID-19 size="lg" />
  ...
  return {
    ...
    rows: [
      ...
      {
        author: <Author image={team3} name="COVID-19" />,
        function: <Job title="Riaydh main helta" />,
        status: (
          <MDBox ml={-1}>
      ...
      {
        author: <Author image={team4} name="COVID-19" />,
